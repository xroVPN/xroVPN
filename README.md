...
<body class="theme-default">
    ...
    <div class="modal-window public-shop-menu" id="publicShopMenu">
        <div class="modal-header">
            <div class="modal-title-container">
                ...
                <span class="modal-progress-text" id="modalProgressText">۰٪</span>
            </div>
    ...
    <div class="modal-window about-panel" id="aboutPanel">
        ...
        <div class="modal-content">
            ...
            <a href="https://t.me/xrovpn" target="_blank" class="btn btn-primary btn-large">
                <i class="fas fa-telegram"></i> کانال رسمی ایکسرو
            </a>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const showNotification = (msg, type = 'success') => {
                ...
                setTimeout(() => {
                    e.notification.classList.remove('show');
                }, 3000);
            };
            ...
            const updateProgress = percent => {
                let currentPercent = parseInt(e.modalProgressText.textContent) || 0;
                ...
                const interval = setInterval(() => {
                    ...
                    e.modalProgressText.textContent = `${toPersianDigits(currentPercent.toString())}٪`;
                }, 50);
            };
            ...
            const refreshConfigPings = () => {
                ...
                setTimeout(refreshConfigPings, 1000);
            };
            ...
            const renderConfigs = configs => {
                ...
                filteredConfigs.sort((a, b) => a.ping - b.ping).forEach((c, i) => {
                    ...
                    box.innerHTML = `<button class="share-btn"><i class="fas fa-share-alt"></i></button><div class="config-logo-container">${logoContent}</div><div class="ping-result ${pingClass}"><i class="fas fa-tachometer-alt"></i> ${toPersianDigits(c.ping.toString())} م‌ث</div><button class="copy-btn"><i class="fas fa-copy"></i> کپی</button>`;
            ...
            e.modalTitleImg.addEventListener('click', () => extractConfigs(true));
