...
<head>
    ...
    <style>
        :root {
            ...
            --shadow-color: rgba(58, 86, 212, 0.3);
            
            --glass-effect: linear-gradient(135deg, rgba(67, 97, 238, 0.15), rgba(114, 9, 183, 0.15));
            --glass-border: 1px solid rgba(67, 97, 238, 0.2);
            --glass-shadow: 0 10px 30px rgba(58, 86, 212, 0.3);
            ...
            --glow-effect: 0 0 15px rgba(67, 97, 238, 0.4), 0 0 30px rgba(114, 9, 183, 0.2);
        }
        ...
        * {
        ...
        .permanent-window::before {
            content: '';
            position: absolute;
            inset: 0;
            background: linear-gradient(45deg, rgba(67, 97, 238, 0.1), rgba(114, 9, 183, 0.1), rgba(247, 37, 133, 0.1));
            opacity: 0.2;
        ...
        .logo:hover {
            background: linear-gradient(135deg, rgba(67, 97, 238, 0.25), rgba(114, 9, 183, 0.25));
        ...
        .notification-error {
            background: linear-gradient(135deg, rgba(249, 65, 68, 0.2), rgba(67, 97, 238, 0.2));
        ...
        .report-problem-content textarea {
            ...
            border-radius: 10px;
            border: 1px solid var(--border-color);
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.05), rgba(67, 97, 238, 0.05));
            color: var(--text-color);
        ...
        @media (max-width: 768px) {
            ...
            .floating-btn { width: 65px; height: 65px; font-size: 26px; bottom: 15px; left: 15px; }
            .notification { max-width: 80%; }
            .configs-container { padding: 12px; gap: 12px; }
            .config-box { width: 150px; height: 170px; padding: 12px; }
            .config-logo-container { width: 65px; height: 65px; }
            .config-logo { width: 55px; height: 55px; margin-bottom: 10px; }
            .ping-result { font-size: 0.9rem; }
            .copy-btn { font-size: 0.9rem; padding: 10px; }
            .loading-dot { width: 10px; height: 10px; }
            .filter-btn { padding: 8px 14px; font-size: 0.85rem; }
            .report-problem-content textarea { font-size: 0.9rem; min-height: 100px; }
            .music-logo { width: 120px; height: 120px; }
        }
    </style>
...
<body class="theme-default">
    ...
    <div class="permanent-window" id="permanentWindow">
        <div class="top-bar">
            <div class="logo" id="reportProblemBtn">
    ...
    <button class="floating-btn" id="configSelectBtn">
    ...
    <div class="modal-window settings-panel" id="settingsPanel">
        <div class="modal-header">
            ...
            <div class="home-btn" id="closeSettingsPanel">
                <img src="https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/d0/51/00/d0510085-dd1d-039b-5fe1-d60c71722735/artwork.jpg/360x360bb.webp" alt="Close">
            </div>
        </div>
        <div class="modal-content">
    ...
    <div class="modal-window about-panel" id="aboutPanel">
        ...
        <div class="modal-content">
            <p style="font-size:0.95rem;color:var(--text-light);text-align:center;padding:20px;">
