...
<head>
    ...
    <style>
        ...
        * {
        ...
        .info-box:nth-child(1) { animation: slideInLeft 0.5s ease-out 0.2s forwards }
        .info-box:nth-child(2) { animation: slideInRight 0.5s ease-out 0.4s forwards }
        .info-box:nth-child(3) { animation: slideInLeft 0.5s ease-out 0.6s forwards }
        ...
        .main-menu, .settings-panel, .about-panel {
            top: -100%;
            right: 0;
            width: 100%;
            max-height: 65%;
        ...
        .main-menu.open, .settings-panel.open, .about-panel.open {
            top: 0
        }
        ...
        .platform-btn, .country-btn, .plan-btn {
            padding: 14px;
            border-radius: 12px;
            background: linear-gradient(135deg, var(--primary-light), var(--primary-dark));
            color: var(--text-color);
        ...
        .platform-btn:hover, .country-btn:hover, .plan-btn:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 16px var(--shadow-color);
            background: linear-gradient(135deg, #4FC3F7, #0288D1)
        }
        .platform-btn:disabled, .country-btn:disabled, .plan-btn:disabled {
            opacity: 0.6;
            cursor: not-allowed;
            transform: none;
            box-shadow: none
        ...
        @media (max-width: 768px) {
            ...
            .config-logo-container { width: 50px; height: 50px }
            .config-logo { width: 40px; height: 40px; margin-bottom: 8px }
            ...
            .report-problem-content textarea { font-size: 0.85rem; min-height: 80px }
            .music-logo { width: 110px; height: 110px }
            .platform-btn, .country-btn, .plan-btn { padding: 12px; font-size: 0.9rem; margin: 10px 0 }
        }
        @keyframes slideInUp {
...
<body class="theme-default">
    ...
    <div class="loading-window" id="loadingWindow">
        <div class="loading-content">
            ...
            <div class="loading-spinner"><div class="loading-frame"></div></div>
    ...
    <div id="contentWindow">
        ...
        <div class="modal-window main-menu" id="mainMenu">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closeMainMenu"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
        ...
        <div class="modal-window config-select-menu" id="configSelectMenu">
            ...
            <div class="modal-content">
                <div class="menu-item" id="privateConfigItem">
                    <div class="menu-item-title"><i class="fas fa-lock"></i><span>استفاده از سرویس‌های شخصی</span></div>
                    <div class="menu-item-desc">میتونی با خرید یک کانفیگ شخصی داشه باشی</div>
                </div>
                <div class="menu-item" id="publicConfigItem">
                    <div class="menu-item-title"><i class="fas fa-globe"></i><span>استفاده از کانفیگ‌های عمومی</span></div>
        ...
        <div class="modal-window private-shop-menu" id="privateShopMenu">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closePrivateShopMenu"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
            <div class="modal-content">
                <div class="subscription-wizard">
                    <div class="wizard-step active" id="step1">
                        <div class="value-display"><span class="unit">انتخاب پلتفرم</span></div>
                        <button class="platform-btn" id="androidBtn"><i class="fab fa-android"></i> اندروید</button>
                        <button class="platform-btn" id="iosBtn"><i class="fab fa-apple"></i> آیفون</button>
                        <button class="platform-btn" id="otherBtn"><i class="fas fa-desktop"></i> سایر موارد</button>
                        <div class="nav-buttons">
                            <button class="nav-btn btn-prev" id="prevStep1" disabled><i class="fas fa-arrow-right"></i> قبلی</button>
                            <button class="nav-btn btn-next" id="nextToStep2" disabled><i class="fas fa-arrow-left"></i> بعدی</button>
                        </div>
                    </div>
                    <div class="wizard-step" id="step2">
                        <div class="value-display"><span class="unit">انتخاب کشور</span></div>
                        <button class="country-btn" data-country="انگلیس"><i class="fas fa-flag"></i> انگلیس</button>
                        <button class="country-btn" data-country="آلمان"><i class="fas fa-flag"></i> آلمان</button>
                        <button class="country-btn" data-country="ترکیه"><i class="fas fa-flag"></i> ترکیه</button>
                        <button class="country-btn" data-country="فرانسه"><i class="fas fa-flag"></i> فرانسه</button>
                        <button class="country-btn" data-country="آلبانی"><i class="fas fa-flag"></i> آلبانی</button>
                        <button class="country-btn" data-country="امارات"><i class="fas fa-flag"></i> امارات</button>
                        <div class="nav-buttons">
                            <button class="nav-btn btn-prev" id="backToStep1"><i class="fas fa-arrow-right"></i> قبلی</button>
                            <button class="nav-btn btn-next" id="nextToStep3" disabled><i class="fas fa-arrow-left"></i> بعدی</button>
                        </div>
                    </div>
                    <div class="wizard-step" id="step3">
                        <div class="value-display"><span class="unit">انتخاب پلن</span></div>
                        <button class="plan-btn" data-plan="300 گیگابایت، 30 روزه، 1 کاربره" data-price="184000"><i class="fas fa-box"></i> 300 گیگابایت، 30 روزه، 1 کاربره - 184,000 تومان</button>
                        <button class="plan-btn" data-plan="600 گیگابایت، 60 روزه، 2 کاربره" data-price="388000"><i class="fas fa-box"></i> 600 گیگابایت، 60 روزه، 2 کاربره - 388,000 تومان</button>
                        <button class="plan-btn" data-plan="900 گیگابایت، 90 روزه، 2 کاربره" data-price="596000"><i class="fas fa-box"></i> 900 گیگابایت، 90 روزه، 2 کاربره - 596,000 تومان</button>
                        <div class="nav-buttons">
                            <button class="nav-btn btn-prev" id="backToStep2"><i class="fas fa-arrow-right"></i> قبلی</button>
                            <button class="nav-btn btn-next" id="nextToStep4" disabled><i class="fas fa-arrow-left"></i> بعدی</button>
                        </div>
                    </div>
                    <div class="wizard-step" id="step4">
                        <div class="price-summary">
                            <div class="price-row"><span>پلتفرم:</span><span id="finalPlatform">--</span></div>
                            <div class="price-row"><span>کشور:</span><span id="finalCountry">--</span></div>
                            <div class="price-row"><span>پلن:</span><span id="finalPlan">--</span></div>
                            <div class="total-price">مبلغ کل: <span id="totalPrice">0 تومان</span></div>
                        </div>
                        <div class="nav-buttons">
                            <button class="nav-btn btn-prev" id="backToStep3"><i class="fas fa-arrow-right"></i> قبلی</button>
                            <button class="nav-btn btn-submit" id="submitPayment"><i class="fas fa-check-circle"></i> ثبت درخواست</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-window public-shop-menu" id="publicShopMenu">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closePublicShopMenu"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
            <div class="modal-content">
        ...
        <div class="modal-window settings-panel" id="settingsPanel">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closeSettingsPanel"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
            <div class="modal-content">
        ...
        <div class="modal-window about-panel" id="aboutPanel">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closeAboutPanel"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
            <div class="modal-content">
                <p style="font-size:0.9rem;color:var(--text-light);text-align:center;padding:20px;">ایکسرو با بیش از ۵ سال فعالیت در زمینه ارائه خدمات فیلترشکن و VPN، با تکیه بر تجربه و تخصص، بهترین راهکارها را برای دسترسی امن و سریع به اینترنت ارائه می‌دهد. ما متعهد به حفظ حریم خصوصی و امنیت کاربران هستیم.</p>
        ...
        <div class="modal-window report-problem-menu" id="reportProblemMenu">
            <div class="modal-header">
                ...
                <div class="home-btn" id="closeReportProblemMenu"><img src="https://biaupload.com/do.php?imgf=org-19fb842c16fb1.png" alt="Close"></div>
            </div>
    ...
    <script>
        // پلی‌فیل برای atob و btoa در صورت عدم وجود
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const e = {
                ...
                finalPlatform: document.getElementById('finalPlatform'),
                finalCountry: document.getElementById('finalCountry'),
            ...
            let selectedPlatform = '', selectedCountry = '', selectedPlan = '', selectedPrice = 0;
            ...
            const toggleModal = (modalId, state, overlayId) => {
                ...
                } else if (!document.querySelector('.modal-window.open')) {
                    document.body.style.overflow = 'auto';
                }
            };

            const closeAllModals = () => {
                document.querySelectorAll('.modal-window').forEach(modal => modal.classList.remove('open'));
            ...
            const updateSummary = () => {
                e.finalPlatform.textContent = selectedPlatform || '--';
                e.finalCountry.textContent = selectedCountry || '--';
                e.finalPlan.textContent = selectedPlan || '--';
                e.totalPrice.textContent = selectedPrice ? `${selectedPrice.toLocaleString('fa-IR')} تومان` : '0 تومان';
            };

            const submitOrder = () => {
                if (!selectedPlatform || !selectedCountry || !selectedPlan) {
                    showNotification('لطفاً همه موارد را انتخاب کنید.', 'error');
                    return;
                }
                const message = `درخواست سفارش سرویس xroVPN:\nپلتفرم: ${selectedPlatform}\nکشور: ${selectedCountry}\nپلن: ${selectedPlan}\nمبلغ کل: ${selectedPrice.toLocaleString('fa-IR')} تومان`;
                window.open(`https://t.me/u0v0n?text=${encodeURIComponent(message)}`, '_blank');
            };

            const submitReportProblem = async () => {
                const message = e.reportProblemText.value.trim();
                if (!message) {
                ...
                try {
                    ...
                    if (result.ok) {
                        ...
                        showNotification('خطا در ارسال گزارش. لطفاً دوباره تلاش کنید.', 'error');
                    }
                } catch (err) {
                    ...
                    for (let i = 0; i < configs.length; i += batchSize) {
                        ...
                        const results = await Promise.all(batch.map(async config => {
                            try {
                                ...
                                return pingResult.success && pingResult.ping <= 600 ? 
                                    { config: formattedConfig, ping: pingResult.ping, protocol: parsed.protocol } : null;
                            } catch (err) {
            ...
            const renderConfigs = (configs, clear = true) => {
                ...
                filteredConfigs.sort((a, b) => a.ping - b.ping).forEach(({ config, ping, protocol }) => {
                    ...
                    box.innerHTML = `
                        ...
                        <div class="ping-result ${pingClass}">
                            <i class="fas fa-tachometer-alt"></i> ${toPersianDigits(ping.toString())} م‌ب
                        </div>
            ...
            // شبیه‌سازی صفحه لودینگ
            setTimeout(() => {
                e.loadingWindow.classList.add('hidden');
                e.contentWindow.style.display = 'block';
                setTimeout(() => {
                    showNotification('به ایکسرو خوش آمدید! از خدمات ما لذت ببرید.', 'success');
                    e.bgMusic.play().catch(() => {
                        showNotification('برای پخش موسیقی، ابتدا با صفحه تعامل کنید.', 'info');
                    });
                }, 500);
            }, 3000); // کاهش زمان لودینگ از 10 به 3 ثانیه

            // فعال کردن موسیقی با کلیک
            document.addEventListener('click', () => {
                if (!e.settingsPanel.classList.contains('open') || !e.playPause.innerHTML.includes('مکث')) {
                    e.bgMusic.play().catch(() => {
                        showNotification('برای پخش موسیقی، ابتدا با صفحه تعامل کنید.', 'info');
                    });
                }
            ...
            // رویدادهای انتخاب پلتفرم
            [e.androidBtn, e.iosBtn, e.otherBtn].forEach(btn => {
                btn.addEventListener('click', () => {
                    selectedPlatform = btn.textContent.replace(/<[^>]+>/g, '').trim();
                    document.getElementById('step1').classList.remove('active');
                    document.getElementById('step2').classList.add('active');
                    e.nextToStep2.disabled = false;
                    e.nextToStep3.disabled = true;
                    e.nextToStep4.disabled = true;
                    updateSummary();
                });
            });

            // رویدادهای انتخاب کشور
            document.querySelectorAll('.country-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    selectedCountry = btn.dataset.country;
                    document.getElementById('step2').classList.remove('active');
                    document.getElementById('step3').classList.add('active');
                    e.nextToStep3.disabled = false;
                    e.nextToStep4.disabled = true;
                    updateSummary();
                });
            });

            // رویدادهای انتخاب پلن
            ...
            e.privateConfigItem.addEventListener('click', () => {
                toggleModal('configSelectMenu', false);
                setTimeout(() => {
                    toggleModal('privateShopMenu', true, 'configSelectOverlay');
                    selectedPlatform = '';
                    selectedCountry = '';
                    selectedPlan = '';
                    selectedPrice = 0;
            ...
            e.settingsItem.addEventListener('click', () => {
                ...
                setTimeout(() => toggleModal('settingsPanel', true, 'mainMenuOverlay'), 300);
            });
            
            e.aboutItem.addEventListener('click', () => {
                toggleModal('mainMenu', false);
                setTimeout(() => toggleModal('aboutPanel', true, 'mainMenuOverlay'), 300);
            });
            ...
            e.closeConfigSelectMenu.addEventListener('click', () => toggleModal('configSelectMenu', false, 'configSelectOverlay'));
            
            e.closePrivateShopMenu.addEventListener('click', () => {
                toggleModal('privateShopMenu', false, 'configSelectOverlay');
                selectedPlatform = '';
                selectedCountry = '';
                selectedPlan = '';
                selectedPrice = 0;
            ...
            e.backToStep1.addEventListener('click', () => {
                document.getElementById('step2').classList.remove('active');
                document.getElementById('step1').classList.add('active');
                e.nextToStep2.disabled = true;
                e.nextToStep3.disabled = true;
            ...
            e.backToStep2.addEventListener('click', () => {
                document.getElementById('step3').classList.remove('active');
                document.getElementById('step2').classList.add('active');
                e.nextToStep3.disabled = true;
                e.nextToStep4.disabled = true;
            ...
            e.backToStep3.addEventListener('click', () => {
                document.getElementById('step4').classList.remove('active');
                document.getElementById('step3').classList.add('active');
                e.nextToStep4.disabled = true;
                updateSummary();
            ...
            e.nextToStep2.addEventListener('click', () => {
            ...
            e.nextToStep3.addEventListener('click', () => {
            ...
            e.nextToStep4.addEventListener('click', () => {
            ...
            e.submitPayment.addEventListener('click', () => {
                submitOrder();
