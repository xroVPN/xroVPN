    ...
    <style>
        ...
        * {
        ...
        @media (min-width: 768px) {
            ...
            .app-header { padding: 2rem 0 1.5rem; }
            .logo-icon { width: 50px; height: 50px; }
            .logo-text { font-size: 1.8rem; }
            .app-description { font-size: 0.95rem; max-width: 700px; }
            .tabs { max-width: 500px; }
            .tab-button { padding: 1rem; font-size: 0.95rem; }
            .tab-content { padding: 1.5rem; min-height: 300px; }
            .message { padding: 1rem 1.5rem; font-size: 0.85rem; }
            .notice-label { padding: 0.3rem 0.8rem; font-size: 0.8rem; }
            .flag-grid { grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 1.2rem; }
            .flag-item { padding: 1.2rem 0.5rem; }
            .flag-item span { font-size: 2.8rem; }
            .flag-item p { font-size: 0.9rem; }
            .status-badge { font-size: 0.7rem; padding: 0.2rem 0.5rem; }
            .modal-content { max-width: 500px; margin: 5% auto; }
            .modal-header { padding: 1.5rem; }
            .modal-header h2 { font-size: 1.3rem; }
            .modal-header h2 span { font-size: 1.6rem; }
            .close-modal { font-size: 1.8rem; top: 1rem; left: 1.5rem; }
            .modal-body { padding: 1.5rem; }
            .modal-tab { padding: 0.8rem 1.2rem; font-size: 0.9rem; }
            .slider-container { margin: 1.5rem 0; }
            .slider-header { font-size: 0.95rem; }
            .slider { height: 8px; margin: 1rem 0; }
            .slider::-webkit-slider-thumb { width: 24px; height: 24px; border: 3px solid white; }
            .price-info { padding: 1rem; font-size: 0.9rem; }
            .final-price { font-size: 1.2rem; }
            .final-price span { font-size: 1.8rem; }
            .order-summary { padding: 1.5rem; }
            .order-summary p { font-size: 0.95rem; }
            .modal-footer { padding: 1.5rem; }
            .btn { padding: 0.9rem 1.8rem; font-size: 0.95rem; width: auto; }
            .btn svg { width: 20px; height: 20px; margin-left: 10px; }
            .download-content { max-width: 600px; padding: 2rem; }
            .download-header h2 { font-size: 1.8rem; }
            .download-header p { font-size: 1rem; }
            .close-download { font-size: 2rem; }
            .download-item { padding: 1.5rem; }
            .download-item h3 { font-size: 1.3rem; }
            .download-item h3 svg { width: 24px; height: 24px; }
            .download-item p { font-size: 0.95rem; }
            .download-btn { padding: 0.8rem 1.5rem; }
            .download-btn svg { width: 20px; height: 20px; margin-left: 8px; }
            .about-content { max-width: 600px; padding: 2rem; }
            .about-header h2 { font-size: 1.8rem; }
            .about-header p { font-size: 1rem; }
            .close-about { font-size: 2rem; }
            ...
            .notification { padding: 1rem 1.8rem; font-size: 0.9rem; }
            .bottom-nav { padding: 1rem; }
            .bottom-nav-btn { max-width: 220px; margin: 0 0.5rem; padding: 1rem; font-size: 0.95rem; }
            .bottom-nav-btn svg { width: 22px; height: 22px; margin-left: 10px; }
        }
        
        @media (min-width: 480px) and (max-width: 767px) {
            .flag-grid { grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); }
            .flag-item span { font-size: 2.7rem; }
            .modal-content { max-width: 90%; }
            .bottom-nav-btn { font-size: 0.9rem; padding: 0.9rem; }
        }
        
        @media (max-width: 479px) {
            .flag-grid { grid-template-columns: 1fr; }
            .flag-item { padding: 0.8rem 0.5rem; }
            .flag-item span { font-size: 2.2rem; }
            .tab-button { padding: 0.7rem; font-size: 0.8rem; }
            .modal-tab { padding: 0.6rem 0.8rem; font-size: 0.8rem; }
            .btn { padding: 0.7rem 1.2rem; font-size: 0.8rem; }
            .social-link { width: 45px; height: 45px; font-size: 1.2rem; }
            .social-link svg { width: 22px; height: 22px; }
            .notification { padding: 0.7rem 1.2rem; font-size: 0.8rem; }
            .bottom-nav-btn { font-size: 0.8rem; padding: 0.7rem; }
