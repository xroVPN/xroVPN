...
<head>
    ...
    <style>
        ...
        .loading-overlay {
            ...
            background: radial-gradient(1200px 300px at 10% 10%, rgba(255,200,120,0.06), transparent 6%),
                       radial-gradient(900px 260px at 90% 80%, rgba(120,160,255,0.04), transparent 6%),
                       repeating-linear-gradient(0deg, var(--bg-line1), var(--bg-line1) 2px, var(--bg-line2) 3px, var(--bg-line2) 6px);
            display: flex;
        ...
        .loading-loader {
            ...
            max-height: var(--loader-max-h);
            border-radius: 999px;
            background: linear-gradient(135deg, #f8f8f8 0%, #f0f0f0 100%);
            box-shadow: inset 4px 4px 10px rgba(0,0,0,0.09),
        ...
        .loading-fill {
            ...
            width: 0%;
            border-radius: 999px;
            background: linear-gradient(90deg, #111 0%, #444 45%, #111 100%);
        ...
        .loading-fill::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(120deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.18) 45%, rgba(255,255,255,0.06) 60%);
            transform: translateX(-120%);
            filter: blur(8px);
            transition: transform 3s linear;
        }

        .loading-loader .loading-label {
            position: absolute;
            left: 12px;
            right: 12px;
            z-index: 4;
        ...
        .loading-loader .loading-label .loading-percent {
...
<body class="theme-default">
    <div class="loading-overlay" id="loadingOverlay">
        <img class="loading-hero" src="https://up.20script.ir/file/969f-InShot-۲۰۲۵۰۹۱۶-۱۷۵۴۲۰۰۹۲.png" alt="ایکسرو" loading="eager">
        <div class="loading-loader" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
            <div class="loading-fill" id="loadingFill" role="img" aria-label="نوار پیشرفت"></div>
            <div class="loading-label">
                <span>یآهَمِه‌ یآ هیچ کَس</span>
                <span class="loading-percent" id="loadingPct" aria-live="polite">0%</span>
            </div>
        </div>
    </div>
    ...
    <div class="modal-window public-shop-menu" id="publicShopMenu" role="dialog" aria-modal="true" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-header">
            <div class="modal-title-container">
                ...
                <span class="modal-title" id="modalTitle">انقضا تا ۲۴:۰۰:۰۰</span>
                <span class="modal-progress-text" id="modalProgressText" style="display:none" aria-live="polite">۰ از ... انجام شده</span>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-content-main">
                <div class="filter-container" id="filterContainer">
                    <button class="filter-btn active" id="sourceBtn" role="button">
                        <i class="fas fa-cloud-download-alt"></i> منبع نما
                    </button>
                    <button class="filter-btn" id="copyAllBtn" role="button">
                        <i class="fas fa-copy"></i> کپی همه
                    </button>
                </div>
                <div class="tab-content active" id="source-tab" role="tabpanel">
                    <div class="configs-container" id="sourceConfigsContainer" aria-live="polite">
                ...
                <div class="config-content-bottom">
                    <div class="config-source-section">
                        <span class="freedom-text">اینترنت آزاد حق مردم ایران است</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        class XroVPN {
            constructor() {
                ...
                this.source = {
                    ...
                    default: 'https://raw.githubusercontent.com/darkvpnapp/CloudflarePlus/refs/heads/main/proxy'
                };
                this.currentProgress = 0;
                this.expiryTimer = null;
                this.countryFlags = {
                    US: '🇺🇸', GB: '🇬🇧', DE: '🇩🇪', FR: '🇫🇷', NL: '🇳🇱', SG: '🇸🇬', JP: '🇯🇵', KR: '🇰🇷', CA: '🇨🇦', AU: '🇦🇺', RU: '🇷🇺', TR: '🇹🇷', IR: '🇮🇷', AE: '🇦🇪', SA: '🇸🇦', IN: '🇮🇳', BR: '🇧🇷', CH: '🇨🇭', SE: '🇸🇪', FI: '🇫🇮', NO: '🇳🇴', DK: '🇩🇰', IT: '🇮🇹', ES: '🇪🇸', PT: '🇵🇹', PL: '🇵🇱', CZ: '🇨🇿', HU: '🇭🇺', AT: '🇦🇹', BE: '🇧🇪', IE: '🇮🇪', IL: '🇮🇱', ZA: '🇿🇦', MX: '🇲🇽', AR: '🇦🇷', CL: '🇨🇱', CO: '🇨🇴', PE: '🇵🇪', VE: '🇻🇪', EC: '🇪🇨', UY: '🇺🇾', PY: '🇵🇾', BO: '🇧🇴', CR: '🇨🇷', PA: '🇵🇦', DO: '🇩🇴', GT: '🇬🇹', SV: '🇸🇻', HN: '🇭🇳', NI: '🇳🇮', PR: '🇵🇷', JM: '🇯🇲', HT: '🇭🇹', BS: '🇧🇸', CU: '🇨🇺', TT: '🇹🇹', GY: '🇬🇾', SR: '🇸🇷', BZ: '🇧🇿', KY: '🇰🇾', BB: '🇧🇧', LC: '🇱🇨', VC: '🇻🇨', GD: '🇬🇩', AG: '🇦🇬', DM: '🇩🇲', KN: '🇰🇳', MS: '🇲🇸', TC: '🇹🇨', VG: '🇻🇬', AI: '🇦🇮', BM: '🇧🇲', FK: '🇫🇰', GI: '🇬🇮', PN: '🇵🇳', SH: '🇸🇭', GS: '🇬🇸', PM: '🇵🇲', WF: '🇼🇫', TF: '🇹🇫', PF: '🇵🇫', NC: '🇳🇨', VU: '🇻🇺', FJ: '🇫🇯', TO: '🇹🇴', WS: '🇼🇸', KI: '🇰🇮', TV: '🇹🇻', NR: '🇳🇷', CK: '🇨🇰', NU: '🇳🇺', TK: '🇹🇰',
                    default: '🌐'
                };
                this.init();
            }
            ...
            cacheElements() {
                const selectors = {
                    ...
                    configsContainer: '#sourceConfigsContainer',
            ...
            initializeTabs() {
                if (this.elements.sourceBtn) this.elements.sourceBtn.addEventListener('click', () => {
                    this.switchTab('source');
                });
                if (this.elements.copyAllBtn) this.elements.copyAllBtn.addEventListener('click', () => {
                    this.copyAllConfigs();
                });
            }
            ...
            copyAllConfigs() {
                ...
                const configsContainer = this.elements.configsContainer;
                if (!configsContainer) return;

                const configBoxes = configsContainer.querySelectorAll('.config-box');
                if (configBoxes.length === 0) {
                    this.showNotification('هیچ کانفیگی برای کپی کردن موجود نیست', 'error');
                    return;
                }

                const allConfigs = Array.from(configBoxes).map(box => {
                    const configData = box.dataset.config;
                    try {
                ...
                if (allConfigs.length === 0) {
                    this.showNotification('هیچ کانفیگ معتبری برای کپی کردن یافت نشد', 'error');
                    return;
                }

                const configsText = allConfigs.join('\n\n---\n\n');
                navigator.clipboard.writeText(configsText).then(() => {
                    this.showNotification(`${allConfigs.length} کانفیگ با موفقیت کپی شد`, 'success');
                }).catch(() => {
                    this.showNotification('خطا در کپی کردن کانفیگ‌ها', 'error');
                });
            }
            ...
            switchTab(tabName) {
                ...
                const filterBtns = [this.elements.sourceBtn, this.elements.copyAllBtn];
                filterBtns.forEach((btn, i) => {
                    if ((i === 0 && tabName === 'source') || (i === 1 && tabName === 'copyAll')) {
                ...
                if (tabName === 'source') {
                    ...
                    this.elements.configsContainer = document.getElementById('sourceConfigsContainer');
                } else {
                    this.elements.configsContainer.innerHTML = '<div class="error" role="alert">به زودی در دسترس خواهد بود</div>';
                }
                this.playButtonSound();
            }
            ...
            bindLoadingAnimation() {
                ...
                requestAnimationFrame(() => {
                    setTimeout(() => {
                        const loadingFill = this.elements.loadingFill,
                              loadingPct = this.elements.loadingPct;
                        if (!loadingFill || !loadingPct) return;
                        ...
                        const tick = now => {
                            const elapsed = Math.min(now - start, duration),
                                  p = Math.round((elapsed / duration) * 100);
            ...
            bindSourceEvents() {
                if (this.elements.sourceBtn) this.elements.sourceBtn.addEventListener('click', () => {
                    this.playButtonSound();
                    this.toggleModal('sourcePanel', true, 'sourceOverlay');
                });
            }
            ...
            bindConfigEvents() {
                if (this.elements.submitSourceUrl) this.elements.submitSourceUrl.addEventListener('click', () => this.submitSourceUrl());
            ...
            formatRemainingTime(milliseconds) {
                ...
                return `${this.toPersianDigits(pad(hours))}:${this.toPersianDigits(pad(minutes))}:${this.toPersianDigits(pad(seconds))}`;
            }
            ...
            updateExpiryDisplay() {
                ...
                if (remainingTime > 0) {
                    ...
                    this.elements.modalTitle.textContent = `انقضا تا ${formattedTime}`;
                } else {
                    this.elements.modalTitle.textContent = 'انقضا متوقف شد - در حال بروزرسانی...';
                    if (this.expiryTimer) {
            ...
            async submitSourceUrl() {
                this.playButtonSound();
                const input = this.elements.sourceUrlInput;
                if (!input) return;

                const url = input.value.trim();
                if (!url) {
                    this.showNotification('لطفاً لینک منبع را وارد کنید', 'error');
                    return;
                }

                try {
                    new URL(url);
                    localStorage.setItem(this.source.key, url);
                    this.showNotification('لینک منبع با موفقیت ثبت شد', 'success');
                    input.value = '';
                    this.toggleModal('sourcePanel', false, 'sourceOverlay');
                    await this.extractConfigs(true);
                    this.startExpiryTimer();
                } catch {
                    this.showNotification('لینک منبع نامعتبر است', 'error');
                }
            }
            ...
            async getLocation(host) {
                try {
                    const response = await fetch(`http://ip-api.com/json/${host}?fields=countryCode`, { cache: 'no-store' });
            ...
            getCachedConfigs() {
                try {
                    ...
                    if (timeElapsed > this.cache.expiry) {
                        ...
                        this.showNotification('کش منقضی شد، در حال بروزرسانی...', 'info');
                        return null;
                    }
                    return data;
                } catch {
            ...
            setCachedConfigs(data) {
                try {
                    ...
                    this.showNotification('کانفیگ‌ها با موفقیت کش شد (۲۴ ساعت)', 'success');
                    this.startExpiryTimer();
                } catch (error) {
            ...
            loadUIState() {
                try {
                    ...
                    this.state.currentTab = currentTab || 'source';
            ...
            getCountryFlag(countryCode) {
                return this.countryFlags[countryCode] || this.countryFlags.default;
            }
            ...
            async extractConfigs(forceRefresh = false) {
                ...
                this.currentProgress = 0;
                if (!forceRefresh && this.getRemainingTime() > 0) {
                    const cachedConfigs = this.getCachedConfigs();
                    if (cachedConfigs) {
                ...
                try {
                    const url = localStorage.getItem(this.source.key) || this.source.default;
                        ...
                        const batch = configs.slice(i, i + batchSize),
                              results = await Promise.all(batch.map(async config => {
                                  try {
                                      ...
                                      const location = await this.getLocation(parsed.host);
                                      return {
            ...
            renderConfigs(configs) {
                ...
                configs.sort((a, b) => a.ping - b.ping).forEach((config, i) => {
                    ...
                    const pingClass = config.ping < 300 ? 'fast' : config.ping < 600 ? 'medium' : 'slow',
                          countryFlag = this.getCountryFlag(config.countryCode);
                    ...
                    box.innerHTML = `
                        ...
                        <div class="config-logo-container" aria-hidden="true">
                            <span class="config-logo">${countryFlag}</span>
                        </div>
